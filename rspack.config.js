...
module.exports = (env, options) => {
  ...
  const main = {
    ...
    entry: {
      boot: './src/app/bootstrap/boot.js',
      main: './src/app/bootstrap/main.js',
      console: './src/ui/panels/console.js',
      searchInFilesWorker: './src/ui/sidebar/searchInFiles/worker.js',
      searchIndexWorker: './src/ui/sidebar/searchInFiles/indexWorker.js',
      htmlLspWorker: './src/editor/codemirror/lsp/workers/html.worker.ts',
      cssLspWorker: './src/editor/codemirror/lsp/workers/css.worker.ts',
      jsonLspWorker: './src/editor/codemirror/lsp/workers/json.worker.ts',
      typescriptLspWorker: './src/editor/codemirror/lsp/workers/typescript.worker.ts',
    },
    output: {
